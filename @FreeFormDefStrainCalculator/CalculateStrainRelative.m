...
%                location in X, Y.
%-------------------------------------------------------------------
function [E, lambda] = CalculateStrainRelative (this, Px, Py, Px0, Py0, MaterialPoints)
    ...
    [dX_1, dX_2, dY_1, dY_2] = this.Derivatives(Px0, Py0, MaterialPoints);
    ...
    lambda(:,2) = sqrt( (2 .* E(:,2) ./ dE_2_sqrd) + 1) - 1;
