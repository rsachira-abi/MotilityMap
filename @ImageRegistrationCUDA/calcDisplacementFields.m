...
function [fieldsX, fieldsY, error] = calcDisplacementFields (this, target_grads)
    ...
    for i = 1:size(target_grads,3)
        ...
        [intX, intY, intError] = this.calcIntegerShift(this.cPaddedTemplateGrad, cuda_target_grad, this.cPaddedPoints, [2, 16, 32]);
        ...
        [subX, subY] = this.calcSubpixelShift (this.cPaddedTemplateGrad, cuda_target_grad, cuda_points, cuda_dispX, cuda_dispY, [2, 16, 32]);
