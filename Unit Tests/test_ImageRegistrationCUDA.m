...
[intX, intY, intError] = reg.calcIntegerShift(gpuArray(gradTemp), gpuArray(gradTarg), gpuArray(points), [2, 16, 32]);
...
[subX, subY] = reg.calcSubpixelShift(gpuArray(gradTemp), gpuArray(gradTarg), gpuArray(points), int32(gpuArray(Disp)), int32(gpuArray(Disp)), [2, 16, 32]);
